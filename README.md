...
| 日期 | 版本 | 更新内容 |
|---|---|---|
| 2026-08-18 | 0.6.0 | ASR 语音反馈:录音→转写→雅思官方 Speaking Band Descriptors 四项评分 (发音由 qwen-omni-turbo 听音频评估)→问题/建议/示范;练习模式逐题反馈卡、全真模拟 summary 逐段折叠反馈;考官卡通形象随音色切换 (女 Jennifer/男 Ethan);考生实时摄像头 (镜像,拒授权降级);全真模拟题量按真考节奏 (P1 主题1 首问+追加 1,主题2/3 各 2,P3 3-4) |
